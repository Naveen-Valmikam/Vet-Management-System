...
namespace AppointmentScheduling.UnitTests.Model
{
    ...
    public class AppointmentCreateShould
    {
        ...
        [Test]
        //[ExpectedException(typeof(ArgumentOutOfRangeException), MatchType = MessageMatch.Contains, ExpectedMessage = "clientId")]
        ...
        [Test]
        //[ExpectedException(typeof(ArgumentOutOfRangeException),MatchType = MessageMatch.Contains, ExpectedMessage = "patientId")]
        ...
        [Test]
        //[ExpectedException(typeof(ArgumentOutOfRangeException),MatchType = MessageMatch.Contains, ExpectedMessage = "roomId")]
        ...
        [Test]
        //[ExpectedException(typeof(ArgumentOutOfRangeException), MatchType = MessageMatch.Contains, ExpectedMessage = "appointmentTypeId")]
        ...
        [Test]
        //[ExpectedException(typeof(ArgumentOutOfRangeException),MatchType = MessageMatch.Contains, ExpectedMessage = "title")]
